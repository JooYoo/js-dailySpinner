...
<div class="spin-progressbar">
    <svg viewbox="0 0 140 140">
      <circle id="ring-bg" cx="70" cy="70"></circle>
      <circle id="ring" cx="70" cy="70"></circle>
    </svg>
</div>
...
class YuProgressRing extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot.querySelector('#ring-bg').setAttribute('r', circleRAtt);
    this.shadowRoot.querySelector('#ring').setAttribute('r', circleRAtt);
